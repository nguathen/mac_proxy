#!/usr/bin/env bash
# install_gostmonitor_autostart.sh
# Cài đặt auto start cho Gost monitor
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🛡️  Cài đặt Auto Start cho Gost Monitor"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
if [ -f "$PLIST_DEST" ]; then
    if launchctl list | grep -q "com.macproxy.gostmonitor" || \
       launchctl print "gui/$(id -u)/com.macproxy.gostmonitor" &>/dev/null; then
        echo ""
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        echo "✅ Gost Monitor auto start đã được cài đặt thành công!"
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        echo ""
        echo "📝 Thông tin:"
        echo "   • Service sẽ tự động khởi động khi đăng nhập"
        echo "   • Plist file: $PLIST_DEST"
        echo "   • Logs: $SCRIPT_DIR/logs/gost_monitor_launchd.log"
        echo ""
        echo "🔧 Lệnh quản lý:"
        echo "   • Kiểm tra status: launchctl list | grep gostmonitor"
        echo "   • Xem logs: tail -f $SCRIPT_DIR/logs/gost_monitor.log"
        echo "   • Start ngay: launchctl start gui/$(id -u)/com.macproxy.gostmonitor"
        echo "   • Bootout: launchctl bootout gui/$(id -u)/com.macproxy.gostmonitor"
        echo ""
    else
